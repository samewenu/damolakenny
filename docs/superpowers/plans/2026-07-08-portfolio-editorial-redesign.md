...
- **Theme:** class names stay `light-theme`/`dark-theme`; **default flips to `light-theme`** (paper). localStorage key stays `portfolio-theme`. Toggle via `classList` add/remove (never `className =`).
